...
describe('total likes', () => {
    ...
    test('when list has multiple blogs, equals respectively', () => {
...
describe('Test for favoriteBlog fn when ', () => {
    test('there is only one blog', () => {
        const result = listHelper.favoriteBlog(listWithOneBlog)
        assert.deepStrictEqual(result, listWithOneBlog[0])
    })

    test('there are many blogs, default', () => {
        const result = listHelper.favoriteBlog(blogs)
        assert.deepStrictEqual(result, blogs[2])
    })

    test('blog list is empty, should should return null', () => {
